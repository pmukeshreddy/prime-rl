...
class InferenceConfig(BaseSettings):
    ...
    # Backend selection: vllm or sglang
    backend: Annotated[
        Literal["vllm", "sglang"],
        Field(
            description="The inference backend to use. Options: 'vllm' (default) or 'sglang'. "
            "SGLang often provides better throughput for RL training workloads.",
        ),
    ] = "vllm"
